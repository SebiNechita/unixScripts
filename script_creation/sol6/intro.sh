...
logFiles=$(find . -maxdepth 1 -name "*_log*")
# Print result
echo "Log files:"
echo "$logFiles"
...
lines=$(cat error_log| grep -n "File does not exist" )
# Print result
